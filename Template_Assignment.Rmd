...
```{r loading_data}
Voorraad_woningen <- read.csv("C:/Users/moham/Desktop/Vooraad_woningen_Google - Voorraad_woningen.csv")
Huishoudens <- read.csv("C:/Users/moham/Desktop/Aantal_huishoudens - Blad1 (2).csv")
```
