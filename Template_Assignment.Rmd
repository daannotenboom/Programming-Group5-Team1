...
housing_stock$Year <- substr(housing_stock$Perioden, 1, 4)
households$Year <- substr(households$Periode, 1, 4)
...
housing_stock_selected <- subset(housing_stock,
                                 (Regio.s == "Nederland" | grepl("Provincie", Regio.s)) &
                                 Year %in% years_to_keep &
                                 grepl("1e kwartaal", Perioden))

households_selected <- subset(households,
                              (Regio.s == "Nederland" | grepl("Provincie", Regio.s)) &
                              Year %in% years_to_keep &
